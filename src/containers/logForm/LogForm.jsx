...
import LogEntry from '../../components/log/logEntry/LogEntry';
import LogDayNavigator from '../../components/log/logDayNavigator/LogDayNavigator';
    ...
    render() {
        ...
        return (
            <div className="container">
                <LogDayNavigator />
                <div className={styles.logTotalAmount}>
                    <FontAwesomeIcon icon={faCheckCircle} />
                    &nbsp;&nbsp;&nbsp;Total =&nbsp;
                    <span>{this.state[`grand_total_${currency}`]}</span>
                    &nbsp;
